 ...
 */
package etalon.purdue.edu.dacapo.bms.xalan;
...
public class XSLTBench {
  ...
  public XSLTBench(File scratch) throws Exception {
    ...
    String versionClass = "org.apache.xalan.Version";
    Class<?> clazz = Class.forName("org.apache.xalan.Version", true, Thread.currentThread().getContextClassLoader());
    Method m = clazz.getMethod("getVersion", null);
    String version = (String) m.invoke(null);
    if (!version.equals(XALAN_VERSION)) {
      System.err.println("***  Incorrect version of Xalan in use!");
      System.err.println("***     Should be '" + XALAN_VERSION + "',");
      System.err.println("***     actually is '" + version + "').");
