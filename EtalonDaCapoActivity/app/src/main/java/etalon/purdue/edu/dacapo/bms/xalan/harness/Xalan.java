 ...
 */
package etalon.purdue.edu.dacapo.bms.xalan.harness;
...
public class Xalan extends Benchmark {
  ...
  public Xalan(Config config, File scratch, PrintStream saveOut,
               PrintStream saveErr) throws Exception {
    super(config, scratch, false, saveOut,
        saveErr);
    Class<?> clazz = Class.forName("etalon.purdue.edu.dacapo.bms.xalan.XSLTBench", true, loader);
