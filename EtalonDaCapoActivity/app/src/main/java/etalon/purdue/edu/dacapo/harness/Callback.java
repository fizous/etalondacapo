...
public class Callback {
   ...
   */
  public boolean runAgain(TestHarness testHarness) {
    if (verbose)
   ...
   */
  public void start(String benchmark, TestHarness testHarness) {
    start(benchmark, mode == Mode.WARMUP, testHarness);
  };

  protected void start(String benchmark, boolean warmup, TestHarness testHarness) {
  ...
  public void complete(String benchmark, boolean valid, TestHarness testHarness ) {
    complete(benchmark, valid, mode == Mode.WARMUP, testHarness);
  };

  protected void complete(String benchmark, boolean valid, boolean warmup, TestHarness testHarness) {
